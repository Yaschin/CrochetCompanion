...
npm run smoke      # 56 assertions; also runs in CI via a postgres:16 service
```
...
| [`docs/archive/`](docs/archive/) | Historical / superseded records — Batches A–D status review, family-profiles plan, photo-coach design, and the early planning docs (kept for provenance, not current) |
