    ...
    <div className="craft-card p-4" style={isLoading ? { opacity: 0.6 } : undefined}>
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <Sparkles className="h-4 w-4" style={{ color: coverage.canMake ? palette.sage : palette.amber }} />
        ...
        <span
          ...
          style={{
            ...
            color: coverage.canMake ? palette.olive : palette.gold,
          }}
        >
                ...
                <div key={i} className="flex items-center gap-2 text-[12.5px]">
                  <span
                    ...
                    style={{
                      ...
                      color: item.have ? palette.olive : palette.rose,
                    }}
                  >
                    {item.have ? <Check className="h-2.5 w-2.5" /> : <X className="h-2.5 w-2.5" />}
                  </span>
                  <span style={{ color: item.have ? palette.cocoa : palette.clay }}>
                    {item.label}
