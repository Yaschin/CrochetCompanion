...
export default function StreakCard() {
  ...
  return (
    <div className="craft-card p-4 flex items-center gap-4">
      ...
      >
        <Flame className="h-5 w-5" style={{ color: streak.current > 0 ? palette.amber : palette.muted }} />
        <span className="font-heading font-bold text-[16px] leading-none mt-0.5" style={{ color: streak.current > 0 ? palette.gold : palette.muted }}>
          {streak.current}
        </span>
      </div>
