    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="font-heading font-bold text-[15px]" style={{ color: "#3D2318" }}>Used up any yarn? 🧶</p>
          ...
          return (
            ...
            >
              <span
                ...
                style={on ? { background: "#84934F", color: "white" } : { border: "1.5px solid rgba(140,100,55,0.4)" }}
              >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[11px]" style={{ color: "#9A7868" }}>
      ...
      <div className="flex items-center gap-2 mt-3">
        <button
          ...
          style={{ background: "rgba(140,100,55,0.08)", color: "#7A5C3E" }}
        >
          Not now
        </button>
        <button
