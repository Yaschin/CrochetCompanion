    ...
    <div className="flex flex-col h-full overflow-y-auto pb-20 md:pb-6">
      ...
      <div className="flex-shrink-0 flex items-center justify-between px-5 pt-5 pb-3"
        ...
        <div className="flex items-center gap-2.5">
          <Heart className="h-5 w-5 fill-current" style={{ color: palette.rose }} />
      ...
      <div className="px-4 pt-4">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <button onClick={() => onNavigate("library")}
              ...
              style={{ background: "rgba(194,78,107,0.1)", color: palette.rose, border: "1px solid rgba(194,78,107,0.25)" }}>
              Browse Library →
            </button>
          </div>
        ) : (
                ...
                <div key={p.id} className="relative rounded-2xl overflow-hidden cursor-pointer transition-transform active:scale-[0.98]"
                  ...
                  <div className="relative aspect-square overflow-hidden" style={{ containerType: "inline-size" }}>
                    ...
                    <button
                      ...
                      <Heart className="h-3.5 w-3.5 fill-current" style={{ color: palette.rose }} />
                    </button>
                  </div>
                  {/* Info */}
        ...
        <div className="mt-6 rounded-2xl p-4 text-center"
          ...
          <p className="font-heading font-semibold text-[13px] mb-1" style={{ color: palette.rose }}>
          ...
          <button onClick={() => onNavigate("community")}
            ...
            style={{ background: palette.rose, color: "white", boxShadow: "0 3px 12px rgba(194,78,107,0.35)" }}>
            Community →
          </button>
        </div>
      </div>
