  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="text-[11px] truncate" style={{ color: "#9A7868" }}>
      ...
      <div className="flex-1 overflow-y-auto px-6 py-4 pb-20 md:pb-4 flex flex-col gap-4">
        ...
        <div className="craft-card craft-card-sage p-4 flex items-center gap-4 overflow-hidden relative">
          ...
          <div className="min-w-0">
            <p className="font-heading font-semibold text-[13px]" style={{ color: "#3D2318" }}>Sheep's stash check</p>
        ...
        {!isLoading && stash.length === 0 && (
          <div className="craft-card p-6 flex flex-col items-center text-center gap-3">
            ...
            <p className="text-[12px]" style={{ color: "#9A7868" }}>Add the yarn and hooks you own and I'll show you what you can make.</p>
        ...
        {ready.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-2">
              <Sparkles className="h-4 w-4" style={{ color: "#84934F" }} />
